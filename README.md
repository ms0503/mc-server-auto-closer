...
- Minecraft 1.20.4
- Architectury API 11.0.7 or later
- Additional dependencies per mod loader below / 以下のMODローダーごとの追加依存

### Fabric

- Fabric Loader 0.14.24 or later
- Fabric API 0.91.1+1.20.4 or later
- Fabric Language Kotlin 1.11.0+kotlin.2.0.0 or later

### Forge

- Forge 1.20.4-49.0.3 or later
- Kotlin for Forge 4.9.0 or later

### NeoForged

- NeoForged 20.4.0-beta or later
- Kotlin for Forge 4.9.0 or later
