...
- Fabric API 0.89.0+1.20.2 or later
- Fabric Language Kotlin 1.11.0+kotlin.2.0.0 or later
- Architectury API 10.0.7 or later

### Forge

- Forge 1.20.2-48.0.0 or later
- Kotlin for Forge 4.4.0 or later
- Architectury API 10.0.7 or later

### NeoForged

- NeoForged 20.2.3-beta or later
- Kotlin for Forge 4.4.0 or later
- Architectury API 10.0.11 or later
